...
-- Personal-time requests (docs/personal-time-plan.md Phase 4): booking personal
-- time always carries a coverage offer, and is only real once another caretaker
-- accepts. See scripts/migrate-personal-time.sql.
